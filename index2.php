...
<html lang="en">
    ...
    <body class="principal">
        <?php require_once 'kzprocess.php'?>
       <nav>
       <div class="logo">
            <h4>CX INFRA</h4>
       </div>
       ...
       <div class="alert alert-<?=$_SESSION['tipomsg']?>">
        ...
        <?php endif ?>
       <div class="wrap">
       <form action="kzprocess.php" method="POST">
       ...
       <div class="kaizen">
        ...
        <div class="kaizen">
                ...
                <textarea id="melhoria" name="melhoria" value="" type="text"><?php echo $melhoria; ?></textarea>
        </div>
        <div class="kaizen">
                <label for="datacon">Data de Conclusão</label>
                <input id="datacon" name="datacon" value="<?php echo $datacon; ?>" type="date">
        </div>
       ...
       <section id="hr2s">
                <span class="hr2">VISUALIZAÇÃO MELHORIAS</span>

                <hr id="hrf">
                </section>
        <?php
            $mysqli = new mysqli ('localhost', 'root', '','cxdi') or die (mysqli_error($mysqli));
            $result = $mysqli-> query("SELECT * FROM kaizen") or die (mysqli_error($mysqli));
            ?>
        <table id="tabkaizen">
            <thead>
                <tr>
            ...
            <?php
                ...
                <tr>
                    ...
                    <div class="buttons">
                    <a id="edit" href="index2.php?edit=<?php echo $linha['numid'];?>" class="btn btn-info">Editar</a>
                    <a id="dng" href="kzprocess.php?delete=<?php echo $linha['numid'];?>" class="btn btn-danger">Deletar</a>
                    </td>
                </tr>
                <?php endwhile;?>
