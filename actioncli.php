...
if (isset($_POST['add'])) {
    ...
    $mysqli->query("INSERT INTO manifest (numid,datarec,datareg,tipo,origem,rastrfonte,escopo,setor,unidade,area,perfil,grteor,voc,resposta,dataresp) VALUES('$numid', '$datarec', '$datareg', '$tipo', '$origem', '$rastrfonte', '$escopo', '$setor', '$unidade', '$area', '$perfil', '$grteor', '$voc', '$resposta', '$dataresp')") or
            die($mysqli->error);
